      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Εμφάνιση οχημάτων με τουλάχιστον n κρατήσεις (n=2) (nested)</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        <thead>
          ...
          <th >ΤΥΠΟΣ ΟΧΗΜΑΤΟΣ </th>
          <th >ΣΥΝΟΛΙΚΕΣ ΚΡΑΤΗΣΕΙΣ </th>
          </tr>
        </thead>
        <tbody>
          <!-- Display records -->
          <tr dir-paginate="query in queries|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
          <td class="text-nowrap">{{query.plate}}</td>
          <td>{{query.veh_type}}</td>
          <td>{{query.total_bookings}}</td>
          </tr>
        </tbody>
