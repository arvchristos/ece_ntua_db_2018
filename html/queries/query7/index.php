      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Εμφάνιση μηνών με ποσοστό κρατήσεων > 15% του συνολικού (GROUP BY)</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        <thead>
          <tr>
          <th >ΜΗΝΑΣ </th>
          <th >ΑΡΙΘΜΟΣ ΚΡΑΤΗΣΕΩΝ</th>
          <th >ΠΟΣΟΣΤΟ ΕΠΙΤΩΝ ΣΥΝΟΛΙΚΩΝ </th>
          </tr>
        </thead>
        <tbody>
          <!-- Display records -->
          <tr dir-paginate="query in queries|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
          <td class="text-nowrap">{{query.month}}</td>
          <td>{{query.number_of_bookings}}</td>
          <td>{{query.percentage_of_total_bookings}}</td>
          </tr>
        </tbody>
