      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Εμφάνιση των επόμενων service και των υπολειπόμενων ημερών μεχρι αυτα, ταξινομηση κατά αύξουσα σειρά υπολειπόμενων ημερών</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        <thead>
          ...
          <th >TΥΠΟΣ ΟΧΗΜΑΤΟΣ </th>
          <th >ΜΟΝΤΕΛΟ </th>
          <th >ΗΜ. ΑΓΟΡΑΣ </th>
          <th >ΤΕΛΕΥΤΑΙΟ ΣΕΡΒΙΣ </th>
          <th >ΕΠΟΜΕΝΟ ΣΕΡΒΙΣ </th>
          <th >ΥΠΟΛ. ΜΕΡΕΣ </th>
          </tr>
        </thead>
        <tbody>
          ...
          <td>{{query.brand}}</td>
          <td>{{query.b_year}}</td>
          <td>{{query.last_service}}</td>
          <td>{{query.next_service}}</td>
          <td>{{query.remaining}}</td>
          </tr>
        </tbody>
          </table>
        </div>
