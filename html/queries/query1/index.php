      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Εμφάνιση οχημάτων που διαχειρίζονται όλα τα υποκαταστήματα της εταιρίας (join query)</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        <thead>
          ...
          <th ng-click="sort('veh_type')">TΥΠΟΣ ΟΧΗΜΑΤΟΣ <span class="glyphicon sort-icon" ng-show="sortKey=='veh_type'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
