      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Αριθμός οχημάτων που διαχειρίζεται συνολικά η εταιρία σε όλα τα υποκαταστήματα της (aggregate function query)</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        <thead>
          ...
          <th >TRUCK</th>
          <th >MINI VAN</th>
          <th >ΣΥΝΟΛΙΚΑ ΟΧΗΜΑΤΑ</th>
          </tr>
        </thead>
        <tbody>
          <!-- Display records -->
          <tr dir-paginate="query in queries|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
          <td >{{query.cars_owned}}</td>
          <td>{{query.motorcycle_owned}}</td>
          <td>{{query.atv_owned}}</td>
          <td>{{query.truck_owned}}</td>
          <td>{{query.mini_van_owned}}</td>
          <td>{{query.Total_vehicles_owned}}</td>
          </tr>
