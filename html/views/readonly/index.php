      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Read only view στατιστικών στοιχείων σχετικά με τις κρατήσεις, τους τύπους οχημάτων και τον τρόπο πληρωμής</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        ...
        <tbody>
          ...
          <td class="text-nowrap">{{query.veh_type}}</td>
          <td>{{query.duration}}</td>
          <td>{{query.credit_card}}</td>
          <td>{{query.cash}}</td>
          <td>{{query.emvasma}}</td>
          </tr>
        </tbody>
