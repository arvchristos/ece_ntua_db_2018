  ...
  <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/html">Media Libre</a>
          </div>
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Queries
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="#">Aggregate query</a></li>
                    <li><a href="#">Aggregate query</a></li>
                    <li><a href="#">Aggregate query</a></li>
                    <li><a href="#">Aggregate query</a></li>
                    <li><a href="#">Aggregate query</a></li>
                ...
                <li class="dropdown">
                  <a class="dropdown-toggle" data-toggle="dropdown" href="#">Views
                    <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="./">Updateable View</a></li>
                      <li><a href="../readonly/">Read only View</a></li>
                    </ul>
                  </li>
            </ul>
          </div><!--/.nav-collapse -->
      ...
      <div class="" style="margin-top:90px;">
        <div class="col-lg-8">
                    <div class="page-header">
                        <h2 id="tables">Ενημερώσιμη όψη του πίνακα υπαλλήλων</h2>
                    </div>
    ...
    <div class="panel-body">
      <table class="table table-striped table-bordered table-list">
        <thead>
          ...
          <th ng-click="sort('store')">ΚΑΤΑΣΤΗΜΑ <span class="glyphicon sort-icon" ng-show="sortKey=='store'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
        ...
        <tbody>
          ...
          <td width=250>
            <?php
              $id= "{{employee.afm}}";
              echo ' ';
              echo '<a class="btn btn-success" href="update.php?afm='.$id.'&afmprev='.$id.'">Update</a>';
              echo ' ';
